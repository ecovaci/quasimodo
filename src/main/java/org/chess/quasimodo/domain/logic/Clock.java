...
public class Clock implements PlayerReadyAware {
	...
	private void onTimeChanged () {
		//send elapsed time on friendly games
		//or remaining time otherwise.
	...
	private boolean isTimeOver () {//TODO - is move gain time done when checking for time over?
		if (gameModel.isFriendly()) {
			return false;
		}
	...
	/* (non-Javadoc)
	 * @see org.chess.quasimodo.domain.logic.PlayerReadyAware#onPlayerReady()
	 */
	@Override
	...
	public String toString() {
		return "Clock [startGameTime=" + startGameTime + ", endGameTime="
				+ endGameTime + ", whiteElapsedSeconds=" + whiteElapsedSeconds
				...
				+ ", elapsedMoveTime=" + elapsedMoveTime + ", startMoveTime="
				+ startMoveTime + ", endMoveTime=" + endMoveTime
				+ ", moveTimeGap=" + moveTimeGap + ", paused=" + paused
				+ ", timeControlIndex=" + timeControlIndex + ", gameModel="
